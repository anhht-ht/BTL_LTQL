...
namespace BTL_LTQL.Controllers
{
    public class PhongbansController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Ma_phong,Ten_phong")] Phongban phongban)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Ma_phong,Ten_phong")] Phongban phongban)
        {
            if (ModelState.IsValid)
            {
